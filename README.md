...
### How to use it
* download the executable *.jar from [[/releases/download/v0.9.0/MoTTL-Transcriptor-0.9-SNAPSHOT-jar-with-dependencies.jar](/releases/download/v0.9.0/MoTTL-Transcriptor-0.9-SNAPSHOT-jar-with-dependencies.jar)]
